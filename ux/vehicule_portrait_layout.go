...
var _ unison.Layout = &VehiculePortraitLayout{}

type VehiculePortraitLayout struct {
	portrait *VehiculePortraitPanel
	rest     *unison.Panel
}

func (p *VehiculePortraitLayout) LayoutSizes(_ *unison.Panel, hint unison.Size) (min, pref, max unison.Size) {
...
func (p *VehiculePortraitLayout) PerformLayout(target *unison.Panel) {
